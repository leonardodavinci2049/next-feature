...
import { getAula, getCurso } from "@/services/cursos";
import { formatarTempo } from "@/services/cursos";
...
const AulaPage = async ({ params }: AulaPageProps) => {
  try {
    const [aula, curso] = await Promise.all([
      getAula(params.slug, params.aulaSlug),
...
export async function generateStaticParams() {
  try {
    const { getCursos, getCurso } = await import("@/services/cursos");
